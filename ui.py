...
class UI:
    def __init__(self,surface):
        ...
        self.coin_rec = self.coin.get_rect(topleft = (50,61))
    ...
    def show_coins(self,amount):
        self.display_surface.blit(self.coin,self.coin_rec)
        coin_amount_surface = self.font.render(str(amount),False,'#33323d')
        coin_amount_rect = coin_amount_surface.get_rect(midleft = (self.coin_rec.right + 4,self.coin_rec.centery))
